...
using Zbizlink.MicroUserManagement.DataModel.StoreProcedure;

namespace Zbizlink.MicroUserManagement.DataModel.Repositories
{
    public class GenericRepository<TEntity> where TEntity : class
    {

        internal Bizlink_TestContext Context;
        internal DbSet<TEntity> DbSet;

        public GenericRepository(Bizlink_TestContext context)
        {
