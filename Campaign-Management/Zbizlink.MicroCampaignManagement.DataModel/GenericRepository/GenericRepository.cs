...
using System.Text;
using Zbizlink.CampaignManagementStoreProcedureModel;
using Zbizlink.CampaignManagementStoreProcedureModel.Enum;
using Zbizlink.MicroCampaignManagement.DataModel.DBContext;

namespace Zbizlink.MicroCampaignManagement.DataModel.GenericRepository
{
    public class GenericRepository<TEntity> where TEntity : class
    {

        internal CampaignManagementContext Context;
        internal DbSet<TEntity> DbSet;

        public GenericRepository(CampaignManagementContext context)
        {
