...
namespace Zdaas.RFPCommon
{
    public class ListTypeRecognition : IListTypeRecognition
    {
        public bool RecognizeListType(LineDetailModel lineDetail)
        {
            ...
            {
                if (Utility.ImgElementExist(lineDetail.Node) == false)
                {
            ...
            string remainingText = lineDetail.Text.Substring(firstWord.Length);
            string numberText;
            typesOfList = GetTypeOfNumberList(firstWord, remainingText, out numberText);
            ...
            if (typesOfList != TypesOfList.None)
            {
                ...
                {
                    lineDetail.TypeOfListNumber = numberText;
                }
        ...
        private TypesOfList GetTypeOfNumberList(string text, string remainingText, out string numberText)
        {
            numberText = "";
            ...
            {
                if(Utility.IsNumberDot(text, remainingText, out numberText) == true){
        ...
        private TypesOfList GetTypeOfCharacterList(string firstWord, bool isHeading)
        {
            ...
            {
                //Example [a.] or [b.]
                if (firstWord.Contains("iii."))
                {
                    var temp = "";
                }
                if (Regex.IsMatch(firstWord, @"^([a-z]{1,3}\.)$"))
                {
                    if (RomanLower(firstWord.Substring(0, firstWord.LastIndexOf('.'))) == true)
                    {
                        return TypesOfList.AmbiguousRomanLowerDot;
                    }
                    //    if (firstWord.Substring(0, firstWord.LastIndexOf('.')) == "i")
                    //{
                    //    return TypesOfList.AmbiguousRomanLowerDot;
                    //}
                    //else if (firstWord.Substring(0, firstWord.LastIndexOf('.')) == "v")
                    //{
                    //    return TypesOfList.AmbiguousRomanLowerDot;
                    //}
                    else
        ...
        private void RemoveWhiteSpace(LineDetailModel lineDetail)
        {
