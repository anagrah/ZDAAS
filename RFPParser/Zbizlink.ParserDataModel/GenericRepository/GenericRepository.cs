...
namespace Zdaas.RFPDataModel.GenericRepository
{
    public class GenericRepository<TEntity> where TEntity : class
    {

        internal ZRFPParserContext Context;
        internal DbSet<TEntity> DbSet;
        
        public GenericRepository(ZRFPParserContext context)
        {
        ...
        public List<T> ExecuteStoredProcedure<T>(string stroredProcedureName, T model)
        {
        ...
        public ICollection<TType> GetSelectedColumnWithWhare<TType>(Expression<Func<TEntity, bool>> where,
        ...
        public IQueryable<TType> GetSelectedColumnWithWhareQ<TType>(Expression<Func<TEntity, bool>> where,
            Expression<Func<TEntity, TType>> select) where TType : class
        {
            IQueryable<TEntity> query = DbSet;
        ...
        public Opportunity GetSavedEmptyOpportunity(decimal opportunityId)
        {
           ...
           DataSet dataSet = ExecuteStoredProcedureFillDataset("",  dataBaseParameterList);
