...
{
    public class BizlinkToCrmfieldsMappingRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public BizlinkToCrmfieldsMappingRepository(CrmDataImport_DBContext dbContext)
        {
