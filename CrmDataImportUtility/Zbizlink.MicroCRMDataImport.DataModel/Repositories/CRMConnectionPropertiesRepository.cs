...
{
    public class CRMConnectionPropertiesRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMConnectionPropertiesRepository(CrmDataImport_DBContext dbContext)
        {
