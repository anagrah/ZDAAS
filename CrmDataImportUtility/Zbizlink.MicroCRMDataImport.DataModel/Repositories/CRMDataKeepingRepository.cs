...
{
    public class CRMDataKeepingRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMDataKeepingRepository(CrmDataImport_DBContext dbContext)
        {
