...
{
    public class CRMImportDataOwnerRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMImportDataOwnerRepository(CrmDataImport_DBContext dbContext)
        {
        ...
        public TEntity GetSingle(Func<TEntity, bool> predicate)
        {
            ...
            return _dbSet.SingleOrDefault<TEntity>(predicate);
        }
