...
{
    public class CRMImportDataUserRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMImportDataUserRepository(CrmDataImport_DBContext dbContext)
        {
