...
{
    public class BizlinkTablesRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public BizlinkTablesRepository(CrmDataImport_DBContext dbContext)
        {
