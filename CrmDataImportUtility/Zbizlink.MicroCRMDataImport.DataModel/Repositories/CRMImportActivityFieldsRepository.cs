...
{
    public class CRMImportActivityFieldsRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMImportActivityFieldsRepository(CrmDataImport_DBContext dbContext)
        {
