...
{
    public class CRMImportActivityRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMImportActivityRepository(CrmDataImport_DBContext dbContext)
        {
