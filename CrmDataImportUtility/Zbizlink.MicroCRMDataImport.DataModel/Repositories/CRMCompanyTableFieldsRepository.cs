...
{
   public class CRMCompanyTableFieldsRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMCompanyTableFieldsRepository(CrmDataImport_DBContext dbContext)
        {
