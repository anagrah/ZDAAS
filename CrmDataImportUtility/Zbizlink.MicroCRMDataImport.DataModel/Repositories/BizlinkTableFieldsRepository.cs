...
{
    public class BizlinkTableFieldsRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public BizlinkTableFieldsRepository(CrmDataImport_DBContext dbContext)
        {
