...
{
    public class CRMModelRepository<TEntity> : ICRMRepository<TEntity> where TEntity : class
    {
        internal CrmDataImport_DBContext _dbContext;
        internal DbSet<TEntity> _dbSet;
        public CRMModelRepository(CrmDataImport_DBContext dbContext)
        {
        ...
        public void ForEach<TEntity>(IEnumerable<TEntity> values, Action<TEntity> action)
        {
