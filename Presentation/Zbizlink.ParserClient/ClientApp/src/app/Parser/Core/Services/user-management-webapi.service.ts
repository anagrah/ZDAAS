...
export class UserManagementWebapiService {
 ...
 public GetUser(email:string): Observable<any> {
  ...
  // Get InActive user to resend sign up emails
 public GetInActiveUser(email:string): Observable<any> {   
   console.log(" Get InActive user to resend sign up emails");
    return this.http.get(`${this.userManagementApiUrl + this.webApiController}GetInActiveUser?email=${email}`)
    .pipe(catchError(this.httpResponseHandlerService.handleError));
  }
