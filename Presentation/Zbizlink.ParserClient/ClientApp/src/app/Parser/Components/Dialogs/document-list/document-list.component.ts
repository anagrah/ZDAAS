...
export class DocumentListComponent implements OnInit {
  ...
  getCompanyOppertunityList() {  
    ...
    if(sessionStorage.getItem('CampaignUser')) {  
       ...
       console.log("Company id in getCompanyOppertunityList method is = " + sessionStorage.getItem('compId'));
     
    }else if(localStorage.getItem('zbizlinkUser')){
    ...
    console.log("Get Company Oppertunity List ====> Company id is = " + companyID);
    this.rfpManipulationWebApiService.getCompanyOppertunityList(this.publishFlag, companyID).subscribe(
      (response) => {
