...
export class DocumentListComponent implements OnInit {
  ...
  getCompanyOppertunityList() {
    ...
    {
        companyID = parseInt(sessionStorage.getItem('compId'));
    }
    else 
    {
    ...
    this.RFPManipulationWebApiService.getCompanyOppertunityList(this.publishFlag, companyID.toString()).subscribe(
      (response) => {
