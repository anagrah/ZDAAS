...
{
    public partial class InitialApplicationConfigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Module_Feature_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Screen_Module_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                name: "CompanyFeaturesMemberShip",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyFeaturesMemberShip", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyFeaturesMemberShip_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyFeaturesMemberShip_Feature_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Feature",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserGroup_AspNetRoles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetRoleClaims_Screen_ScreenId",
                        column: x => x.ScreenId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoleClaims_ScreenId",
                table: "AspNetRoleClaims",
                column: "ScreenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyFeaturesMemberShip_FeatureId",
                table: "CompanyFeaturesMemberShip",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyFeaturesMemberShip_UserId",
                table: "CompanyFeaturesMemberShip",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Module_FeatureId",
                table: "Module",
                column: "FeatureId");
